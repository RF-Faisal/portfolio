/**
 * PORTFOLIO RESOURCE MAP
 * ----------------------
 * 1. Upload images into assets/images/.
 * 2. Add the relative path below, e.g. "assets/images/profile.jpg".
 * 3. Add video, project, LinkedIn and Scholar URLs under links.
 * Empty values keep the styled placeholder visible.
 */
window.PORTFOLIO_RESOURCES = {
  images: {
    ...
    projectPhoenixRover: { src: "", alt: "PHOENIX 3.0 Mars Rover" },
